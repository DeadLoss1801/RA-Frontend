...
//     props.onChangeResponse3(e.target.value);
// }

const handleClick = (e) =>{

  if (e.target.value === props.response3) {
    props.onChangeResponse3(null);
  } else {
    props.onChangeResponse3(e.target.value);
  }
}
...
return (
    ...
    <Paper elevation={3} sx={{width:"100%",height:350}}>
     <Box sx={{p:3}}>
     <Typography variant="h6" >{`Q.3  ${props.item.question_text}`}</Typography>
