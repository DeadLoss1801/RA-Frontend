...
//     props.onChangeResponse4(e.target.value);
// }

const handleClick = (e) =>{

  if (e.target.value === props.response4) {
    props.onChangeResponse4(null);
  } else {
    props.onChangeResponse4(e.target.value);
  }
}
...
return (
    ...
    <Paper elevation={3} sx={{width:"100%",height:350}}>
     <Box sx={{p:3}}>
     <Typography variant="h6" >{`Q.4  ${props.item.question_text}`}</Typography>
